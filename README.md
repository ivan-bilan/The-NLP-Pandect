...
* [fastText](https://github.com/facebookresearch/fastText) [GitHub, 23805 stars]
...
* [sentence-transformers](https://github.com/UKPLab/sentence-transformers) - Multilingual Sentence & Image Embeddings with BERT [GitHub, 8197 stars]
...
* [multilingual-t5](https://github.com/google-research/multilingual-t5) - Multilingual T5 (mT5) is a massively multilingual pretrained text-to-text transformer model [GitHub, 889 stars]
##### BigBird
...
* [best-of-ml-python](https://github.com/ml-tooling/best-of-ml-python) [GitHub, 11300 stars]
...
* [Optuna](https://github.com/optuna/optuna) - hyperparameter optimization framework [GitHub, 6749 stars]
...
* [CheckList](https://github.com/marcotcr/checklist) - Beyond Accuracy: Behavioral Testing of NLP models [GitHub, 1716 stars]
...
* [Great Expectations](https://github.com/great-expectations/great_expectations) - Write tests for your data [GitHub, 6964 stars]
* [Deepchecks](https://github.com/deepchecks/deepchecks) - Python package for comprehensively validating your machine learning models and data [GitHub, 1783 stars]
...
* [KFServing](https://github.com/kubeflow/kfserving) - Serverless Inferencing on Kubernetes [GitHub, 1654 stars]
...
* [Metaflow](https://github.com/Netflix/metaflow) - human-friendly Python/R library that helps scientists and engineers build and manage real-life data science projects [GitHub, 5875 stars]
* [flyte](https://github.com/flyteorg/flyte) - workflow automation platform for complex, mission-critical data and ML processes at scale [GitHub, 2554 stars]
...
* [FEAST](https://github.com/feast-dev/feast) - open source feature store for machine learning [Website](https://feast.dev/) [GitHub, 3459 stars]
...
* [Bert-as-service](https://github.com/hanxiao/bert-as-service) [GitHub, 10558 stars]
...
* [Basic Utilities for PyTorch NLP](https://github.com/PetrochukM/PyTorch-NLP) by [PetrochukM](https://github.com/PetrochukM) [GitHub, 2099 stars]
...
* [DeepSpeech](https://github.com/mozilla/DeepSpeech) - Baidu's DeepSpeech architecture [GitHub, 19998 stars]
...
* [ESPnet](https://github.com/espnet/espnet) - End-to-End Speech Processing Toolkit [GitHub, 5337 stars]
...
* [TTS](https://github.com/coqui-ai/TTS) - a deep learning toolkit for Text-to-Speech [GitHub, 5600 stars]
...
* [textrank](https://github.com/summanlp/textrank) - TextRank implementation for Python 3 [GitHub, 1135 stars]

### RAKE - Rapid Automatic Keyword Extraction
* [rake-nltk](https://github.com/csurfer/rake-nltk) - Rapid Automatic Keyword Extraction algorithm using NLTK [GitHub, 931 stars]
* [yake](https://github.com/LIAAD/yake) - Single-document unsupervised keyword extraction [GitHub, 1127 stars]
...
* [LAMA](https://github.com/facebookresearch/LAMA) - LAMA is a probe for analyzing the factual and commonsense knowledge contained in pretrained language models [GitHub, 915 stars]
...
* [InterpretML](https://github.com/interpretml/interpret) - Fit interpretable models. Explain blackbox machine learning [GitHub, 4885 stars]
...
-----
### General Purpose
* [spaCy](https://github.com/explosion/spaCy) by Explosion AI [GitHub, 23929 stars]
* [flair](https://github.com/flairNLP/flair) by Zalando [GitHub, 11907 stars]
...
* [AdaptNLP](https://github.com/Novetta/adaptnlp) - A high level framework and library for NLP [GitHub, 400 stars]
...
* [NLPAug](https://github.com/makcedward/nlpaug) Data augmentation for NLP [GitHub, 3422 stars]
...
* [faker](https://github.com/joke2k/faker) - Python package that generates fake data for you [GitHub, 14530 stars]
...
* [TextAttack](https://github.com/QData/TextAttack) - framework for adversarial attacks, data augmentation, and model training in NLP [GitHub, 2036 stars]
* [CleverHans](https://github.com/tensorflow/cleverhans) - adversarial example library for constructing NLP attacks and building defenses [GitHub, 5552 stars]
* [CheckList](https://github.com/marcotcr/checklist) - Beyond Accuracy: Behavioral Testing of NLP models [GitHub, 1716 stars]

### Transformer-oriented
* [transformers](https://github.com/huggingface/transformers) by HuggingFace [GitHub, 67935 stars]
* [Adapter Hub](https://github.com/Adapter-Hub/adapter-transformers) and its [documentation](https://docs.adapterhub.ml/index.html) - Adapter modules for Transformers [GitHub, 941 stars]
* [haystack](https://github.com/deepset-ai/haystack) - Transformers at scale for question answering & neural search. [GitHub, 5148 stars]

### Dialog Systems and Speech
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov) by MIPT [GitHub, 5824 stars]
* [ParlAI](https://github.com/facebookresearch/ParlAI) by FAIR [GitHub, 9057 stars]
* [rasa](https://github.com/RasaHQ/rasa) - Framework for Conversational Agents [GitHub, 14653 stars]
* [wav2letter](https://github.com/facebookresearch/wav2letter) - Automatic Speech Recognition Toolkit [GitHub, 6081 stars]
* [ChatterBot](https://github.com/gunthercox/ChatterBot) - conversational dialog engine for creating chat bots [GitHub, 12455 stars]
* [SpeechBrain](https://github.com/speechbrain/speechbrain) - open-source and all-in-one speech toolkit based on PyTorch [GitHub, 4410 stars]

### Word/Sentence-embeddings oriented
* [MUSE](https://github.com/facebookresearch/MUSE) A library for Multilingual Unsupervised or Supervised word Embeddings [GitHub, 2985 stars]
...
### Phonetics
* [DeepPhonemizer](https://github.com/as-ideas/DeepPhonemizer) - grapheme to phoneme conversion with deep learning [GitHub, 159 stars]
...
* [argos-translate](https://github.com/argosopentech/argos-translate) - Open source neural machine translation in Python [GitHub, 1271 stars]
...
* [fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - Fuzzy String Matching in Python [GitHub, 8724 stars]
...
* [Doccano](https://github.com/doccano/doccano) - open source annotation tool for machine learning practitioners [GitHub, 6537 stars]
...
* [Treasure of Transformers](https://github.com/ashishpatel26/Treasure-of-Transformers) - Natural Language processing papers, videos, blogs, official repos along with colab Notebooks [GitHub, 355 stars]
...
* [nlp-tutorial](https://github.com/graykode/nlp-tutorial) - Natural Language Processing Tutorial for Deep Learning Researchers [GitHub, 11235 stars]
...
* [Transformers-Tutorials](https://github.com/NielsRogge/Transformers-Tutorials) - demos with the Transformers library by HuggingFace [GitHub, 1786 stars]
...
* [SentencePiece](https://github.com/google/sentencepiece) - Unsupervised text tokenizer for Neural Network-based text generation [GitHub, 6087 stars]
...
* [EDA](https://github.com/jasonwei20/eda_nlp) - Easy Data Augmentation Techniques for Boosting Performance on Text Classification Tasks [GitHub, 1294 stars]
* [snorkel](https://github.com/snorkel-team/snorkel) Framework to generate training data [GitHub, 5220 stars]
...
* [LDNOOBW](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) - List of Dirty, Naughty, Obscene, and Otherwise Bad Words [GitHub, 1861 stars]
...
* [TPOT](https://github.com/EpistasisLab/tpot) - Python Automated Machine Learning tool [GitHub, 8681 stars]
* [Auto-PyTorch](https://github.com/automl/Auto-PyTorch) - Automatic architecture search and hyperparameter optimization for PyTorch [GitHub, 1721 stars]
...
#### Text Generation
* [keytotext](https://github.com/gagan3012/keytotext) - a model which will take keywords as inputs and generate sentences as outputs [GitHub, 304 stars]
